...
const CHANNEL_TYPE_DISPLAY_ORDER: number[] = [
  ...
  23, 18, 45, 31, 35, 49, 19, 47, 37, 38, 39, 11, 8, 57, 61, 62, 59, 22, 21, 44,
...
export const TYPE_TO_KEY_PROMPT: Record<number, string> = {
  ...
  61: 'Paste the OpenCode Go API key, or the opencode-go entry of auth.json',
  62: 'Paste the WorkBuddy credential JSON (refreshToken required)',
}
