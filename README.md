...
| 🔐 Codex Channel Authorization | [Independent ChatGPT OAuth](./docs/codex-oauth.md) |
...
### WorkBuddy channel integration

This fork adds a WorkBuddy / CodeBuddy channel (type 62) with account credential import, automatic token renewal, the upstream request header families, the chat request body pipeline, catalog model discovery and credit balance queries. See [WorkBuddy channel documentation](./docs/workbuddy.md).
